      ...
      <main className={classes.content}>
        ...
        <Grid container direction="row">
          <Grid item style={{ width: "50%" }}>
            <Typography variant="h4">Please submit your roster.</Typography>
            <Typography>
              If you have already submitted a roster for this semester, it will
            ...
            <div className={classes.uploadContainer}>
              ...
              <img
                alt="Example CSV"
                src={require("../Images/exampleCSV.PNG")}
              />
              <CSVReader
            ...
            {roster.length > 0 ? (
              <Card style={{ padding: "10px" }}>
                {roster.map((roster, index) => (
                  ...
                  >
                    <Grid item style={{ width: "50%" }}>
                      <Typography align="left">{roster.name}</Typography>
                    </Grid>
                    <Grid item style={{ width: "50%" }}>
                      <Typography align="left">{roster.onyen}</Typography>
                    </Grid>
                  </Grid>
                ))}
              </Card>
